        ...
        <table border="1"> 
			...
			?>
				<tr class="gradeX">
					...
					<td><?php echo $row->nama_status_project; ?></td>
					<td>
						<?php
					...
					<td><?php echo "(".$row->priority.") ".$row->nama_priority_project; ?></td>
            ...
            <?php 
				$no=1;
				if(isset($data_project_report)){
					foreach($data_project_report as $row){ 
			?>
				<tr>
					<td><?php echo $no++; ?></td>
					<td><?php echo $row->projectname; ?></td>
