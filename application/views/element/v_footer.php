...
(function() {
	...
	*/
	Morris.Bar({
		...
		"<?php echo $d1->nama_status_project;?>",<?php } ?>],
		labels: [
		<?php foreach($data_grafikstatus as $a1){?>
		"<?php echo $a1->nama_status_project;?>",<?php } ?>],
		hideHover: true
	});
	})();
</script>
...
(function() {
	...
	*/
	Morris.Bar({
		...
		"<?php echo $d2->nama_status_project;?>",<?php } ?>],
		labels: [
		<?php foreach($data_grafikstatus as $a2){?>
		"<?php echo $a2->nama_status_project;?>",<?php } ?>],
		hideHover: true
	});
	})();
</script>
...
<!-- js grafik Timeline Project-->
<script type="text/javascript">
window.onload = function () {
	var chart = new CanvasJS.Chart("lamaprojectsudahjalan",
	{
		toolTip: {
			shared: true,
			contentFormatter: function (e) {
				...
				for (var i = 0; i < e.entries.length; i++) {
					content += e.entries[i].dataPoint.label + " = " + e.entries[i].dataPoint.y + " Hari";
					content += "<br/>";
				}
				return content;
			}
		...
		{        
			...
			dataPoints: [ 
				<?php $no=1; $n=1; foreach($data_hari_sudah_berjalan as $d){?>
				{ x: <?php echo $no++; ?>, y: <?php echo $d->jumlah_hari_berjalan;?>, label: '<?php echo $d->projectname;?>-<?php echo $n++; ?>'},
				<?php } ?>
			]	
		}
		]
  ...
  function onMouseover(e){
  	("Project "+ e.dataPoint.label +" sudah berjalan "+ e.dataPoint.y +" hari" );
  }
}
</script>
<!-- js grafik Timeline Project-->
